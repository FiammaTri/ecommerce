...
public class AuthController {
	...
	/**
	 * Endpoint per effettuare il login. Riceve username e password in formato JSON
	 * e restituisce il token se le credenziali sono valide.
	 *
	...
	public Map<String, String> login(@RequestBody Map<String, String> body, HttpServletResponse response) {
		...
		//messaggio di errore se non presente l'utente
